  ...
  return (
    <div className="min-h-screen bg-[#0a0e1a] text-white font-sans overflow-x-hidden">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[260px_1fr] xl:grid-cols-[260px_1fr_300px] h-[calc(100vh-60px)]">
        ...
        {/* Main Content */}
        <main className="bg-[#0a0e1a] xl:overflow-y-scroll scrollbar scrollbar-thumb-gray-500 scrollbar-track-gray-[#262a39] scrollbar-w-2 scrollbar-track-rounded-full scrollbar-thumb-rounded-full p-5">
          {/* Dashboard Header */}
        ...
        {/* Right Sidebar */}
        <aside className="xl:bg-[#1a1f2e] lg:col-start-2 xl:col-start-3 border-l border-[#2a3441]  xl:overflow-y-scroll scrollbar scrollbar-thumb-gray-500 scrollbar-track-gray-[#262a39] scrollbar-w-2 scrollbar-track-rounded-full scrollbar-thumb-rounded-full p-5">
          {/* Portfolio Card */}
